...
namespace Upgrow.Application.Services.ActionLogs
{
    ...
    {
        private readonly IActionLogsRepository _repository;
   

         

        public ActionLogsService(IActionLogsRepository repository)
        {
            _repository = repository;
        }

        /// <summary>
        /// Gets a single action log by ID for detail view - optimized.
        /// </summary>
            ...
            PaginationParams pagination)
        {
            ...
            Expression<Func<ActionLog, bool>>? searchFilter = null;
