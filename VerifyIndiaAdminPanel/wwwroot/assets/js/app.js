...
function initializeMenusAndUI() {
    // Check if required elements exist
    if (!document.getElementById("tab-menu")) {
        setTimeout(initializeMenusAndUI, 100);
        return;
    }
...
try {
    document.getElementById("togglemenu").addEventListener("click", function (e) {
        ...
        const activeTab = document.querySelector('#tab-menu .nav-link.active');
    if (activeTab) {
            ...
            e.parentElement.parentElement.classList.contains("navbar-nav") ||
                ((o = e.closest(".collapse")) &&
                    ...
                    (a = o.parentElement.closest(".collapse")) &&
                        ...
                        a.parentElement.childNodes[1].setAttribute("aria-expanded", "true")))),
        ...
        n &&
            ...
            (t = getClosest(n, ".parent-menu-item"))
                ? (t.classList.add("active"),
                  ...
                  (a = getClosest(t, ".parent-parent-menu-item")) && a.classList.add("active"))
...
[].forEach.call(dropdowns, function (t) {
    ...
    document.querySelectorAll(".menu-body a").forEach(function (e, t) {
        ...
        e.href == a &&
            ...
            "sidebar-menu" !==
                (e = n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode).getAttribute("id") &&
            ...
            n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                ...
                ?.setAttribute("aria-expanded", "true"),
            (a =
                n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode) &&
                a instanceof HTMLElement &&
                "wrapper" !== a.getAttribute("id") &&
                a.classList.add("show"),
            (e =
                (e =
                    n.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode
                        .parentNode) && e.parentNode) && e.classList.add("menuitem-active"));
    }),
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initializeMenusAndUI);
} else {
    initializeMenusAndUI();
}
