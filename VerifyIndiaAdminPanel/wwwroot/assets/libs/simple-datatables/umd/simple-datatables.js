                ...
                function (require, module, exports) {
                        ...
                        sort(t, e, s) {
                            ...
                            Promise.all(p).then((n) => {
                                ...
                                Array.from(r).forEach((e) => {
                                    ...
                                    i.lastTh &&
                                        c != i.lastTh &&
                                        (i.lastTh.classList.remove("desc"), i.lastTh.classList.remove("asc")),
                                    (i.lastTh = c),
                                    (r = u.concat(g)),
                                    (i.data = []);
                                const f = [];
                    ...
                    class o {
                        ...
                        renderPage() {
                            if (
                                (this.hasHeadings &&
                                    (s(this.header), this.activeHeadings.forEach((t) => this.header.appendChild(t))),
                                    ...
                                    if ("txt" === o.type || "csv" === o.type) {
                                        ...
                                        for (h = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++)
                                            !o.skipColumn.includes(s[n].originalCellIndex) &&
                                                ...
                                                (h += `\`${s[n].textContent}\`,`);
                                        for (
                                            h = h.trim().substring(0, h.length - 1), h += ") VALUES ", n = 0;
                                            n < i.length;
                                            n++
                                        ) {
