!(function (t, n) {
    ...
    const n = function (n) {
        ...
        let u, d, p, x, h, b, v, M, y, F, S, w, A, z, V, T, C, N, O;
        !1 !== c &&
            delete (n = (function (t) {
                t = t || {};
                for (let n = 1; n < arguments.length; n++)
                    if (arguments[n])
                        for (const e in arguments[n])
                            Object.prototype.hasOwnProperty.call(arguments[n], e) && (t[e] = arguments[n][e]);
                return t;
            })({}, n, c)).defaults,
            (e.config = {
                id: n.id,
            ...
            null !== e.config.id && null !== document.getElementById(e.config.id)
                ...
                : null !== e.config.parentNode && (e.canvas = t(e.config.parentNode, "100%", "100%")),
            !0 === e.config.relativeGaugeSize
                ...
                : null !== e.config.width && null !== e.config.height
                  ...
                  : null !== e.config.parentNode
                    ? (e.canvas.setViewBox(0, 0, 200, 100, !0), (u = 200), (d = 100))
                    : ((u = 1 * m(document.getElementById(e.config.id), "width").slice(0, -2)),
                      (d = 1 * m(document.getElementById(e.config.id), "height").slice(0, -2))),
            !0 === e.config.donut
                ? (u > d ? (p = x = d) : (x = p = u),
                  (b = (u - p) / 2),
                  (v = (d - x) / 2),
                  ...
                  (y = b + p / 2),
                  (w = b + p / 2),
                  (A = (F = "" !== e.config.label ? v + x / 1.85 : v + x / 1.7) + (S = x / 16 > 10 ? x / 16 : 10)),
                  (z = x / 16 > 10 ? x / 16 : 10),
                  (V = b + p / 10 + ((p / 6.666666666666667) * e.config.gaugeWidthScale) / 2),
                  (T = A),
                  (C = x / 16 > 10 ? x / 16 : 10),
                  (N = b + p - p / 10 - ((p / 6.666666666666667) * e.config.gaugeWidthScale) / 2),
                  (O = A))
                : (u > d
                  ...
                  (b = (u - p) / 2),
                  (v = (d - x) / 2),
                  (M = x / 6.5 > e.config.valueMinFontSize ? x / 6.5 : e.config.valueMinFontSize),
                  (y = b + p / 2),
                  (F = v + x / 1.275),
                  (S = x / 16 > e.config.labelMinFontSize ? x / 16 : e.config.labelMinFontSize),
                  (w = b + p / 2),
                  (A = F + M / 2 + 5),
                  (z = x / 16 > e.config.minLabelMinFontSize ? x / 16 : e.config.minLabelMinFontSize),
                  (V = b + p / 10 + ((p / 6.666666666666667) * e.config.gaugeWidthScale) / 2),
                  (T = A),
                  (C = x / 16 > e.config.maxLabelMinFontSize ? x / 16 : e.config.maxLabelMinFontSize),
                  (N = b + p - p / 10 - ((p / 6.666666666666667) * e.config.gaugeWidthScale) / 2),
                  (O = A)),
            (e.params = {
                canvasW: u,
            ...
            (e.canvas.customAttributes.pki = function (t) {
                let n = e.config.min,
                    i = e.config.max;
                const o = e.params.widgetW,
                    a = e.params.widgetH,
                    l = e.params.dx,
                    r = e.params.dy,
                    c = e.config.gaugeWidthScale,
                    f = e.config.donut;
                let s, m, g, u, d, p, x, h, b, v;
                return (
                    n < 0 && ((i -= n), (t -= n), (n = 0)),
                    f
                        ? ((s = (1 - (2 * (t - n)) / (i - n)) * Math.PI),
                          ...
                          (d = a / 2 + r),
                          (p = (u = o / 2 + l) + m * Math.cos(s)),
                          (x = d - m * Math.sin(s)),
                          (h = u + g * Math.cos(s)),
                          (b = d - g * Math.sin(s)),
                          (v = "M" + (u - g) + "," + d + " "),
                          (v += "L" + (u - m) + "," + d + " "),
                          t - n > (i - n) / 2 && (v += "A" + m + "," + m + " 0 0 1 " + (u + m) + "," + d + " "),
                          (v += "A" + m + "," + m + " 0 0 1 " + p + "," + x + " "),
                          (v += "L" + h + "," + b + " "),
                          t - n > (i - n) / 2 && (v += "A" + g + "," + g + " 0 0 0 " + (u + g) + "," + d + " "),
                          (v += "A" + g + "," + g + " 0 0 0 " + (u - g) + "," + d + " "),
                          { path: (v += "Z ") })
                        : ((s = (1 - (t - n) / (i - n)) * Math.PI),
                          (v =
                              "M" +
                              ((u = o / 2 + l) - (g = (m = o / 2 - o / 10) - (o / 6.666666666666667) * c)) +
                              "," +
                              (d = a / 1.25 + r) +
                              " "),
                          (v += "L" + (u - m) + "," + d + " "),
                          (v +=
                              ...
                              (x = d - m * Math.sin(s)) +
                              " "),
                          (v += "L" + (h = u + g * Math.cos(s)) + "," + (b = d - g * Math.sin(s)) + " "),
                          (v += "A" + g + "," + g + " 0 0 0 " + (u - g) + "," + d + " "),
                          { path: (v += "Z ") })
                );
            }),
                ...
                return (
                    ...
                    f
                        ? ((s = (1 - (2 * (t - n)) / (i - n)) * Math.PI),
                          ...
                          (M = x - T * Math.cos(s)),
                          (y = h + T * Math.sin(s)),
                          (z = "M" + (F = M + C * Math.sin(s)) + "," + (S = y + C * Math.cos(s)) + " "),
                          (z += "L" + (w = M - C * Math.sin(s)) + "," + (A = y - C * Math.cos(s)) + " "),
                          (z += "L" + b + "," + v + " "),
                          { path: (z += "Z ") })
                        : ((s = (1 - (t - n) / (i - n)) * Math.PI),
            ...
            (e.gauge = e.canvas.path().attr({ stroke: "none", fill: e.config.gaugeColor, pki: [e.config.max] })),
            (e.level = e.canvas
                .path()
                .attr({
                    stroke: "none",
            ...
            (e.txtLabel = e.canvas.text(e.params.labelX, e.params.labelY, e.config.label)),
            e.txtLabel.attr({
        ...
        if (
            ...
            e.config.textRenderer && !1 !== e.config.textRenderer(e.originalValue)
                ...
                : e.config.humanFriendly
                  ? (e.originalValue = f(e.originalValue, e.config.humanFriendlyDecimal) + e.config.symbol)
                  : e.config.formatNumber
                    ? (e.originalValue = s(e.originalValue) + e.config.symbol)
                    : e.config.displayRemaining
                      ? (e.originalValue =
                            (1 * (e.config.max - e.originalValue)).toFixed(e.config.decimals) + e.config.symbol)
                      : (e.originalValue = (1 * e.originalValue).toFixed(e.config.decimals) + e.config.symbol),
            !0 === e.config.counter)
        ) {
            const t = function () {
                    let t = e.level.attr("pki")[0];
                    e.config.reverse && (t = 1 * e.config.max + 1 * e.config.min - 1 * e.level.attr("pki")[0]),
                        e.config.textRenderer && !1 !== e.config.textRenderer(Math.floor(t))
                            ? e.txtValue.attr("text", e.config.textRenderer(Math.floor(t)))
                            : e.config.humanFriendly
                              ? e.txtValue.attr(
                                    "text",
                                    f(Math.floor(t), e.config.humanFriendlyDecimal) + e.config.symbol
                                )
                              : e.config.formatNumber
                                ...
                                : e.config.displayRemaining
                                  ? e.txtValue.attr(
                                        "text",
                                        (1 * (e.config.max - t)).toFixed(e.config.decimals) + e.config.symbol
                                    )
                                  : e.txtValue.attr("text", (1 * t).toFixed(e.config.decimals) + e.config.symbol),
                        l(e.txtValue, e.params.valueFontSize, e.params.valueY),
                        (t = null);
                },
                n = function () {
        ...
        e.config.reverse && (I = 1 * e.config.max + 1 * e.config.min - 1 * e.config.value),
            e.level.animate(
                { pki: [I] },
            ...
            e.config.pointer &&
                e.needle.animate({ ndl: [I] }, e.config.startAnimationTime, e.config.startAnimationType),
            e.txtValue.animate(
                { "fill-opacity": e.config.hideValue ? "0" : "1" },
                e.config.startAnimationTime,
                e.config.startAnimationType
            ),
            e.txtLabel.animate({ "fill-opacity": "1" }, e.config.startAnimationTime, e.config.startAnimationType);
    };
    function e(t, n, e) {
        switch (n) {
            case "valueFontColor":
    ...
    function a(t, n, e, i, o) {
        ...
        if (((i = i || h), h)) {
            ...
            for (let n = 0; n < o.ranges.length; n++)
                if (t >= o.ranges[n].lo && t <= o.ranges[n].hi) return o.ranges[n].color;
        }
        const b = e.length;
        if (1 === b) return e[0];
        const v = i ? 1 / b : 1 / (b - 1),
        ...
        for (let t = 0; t < e.length; t++)
            (a = i ? v * (t + 1) : v * t),
                ...
                (M[t] = { pct: a, color: { r: l, g: c, b: f } });
        if (0 === n) return "rgb(" + [M[0].color.r, M[0].color.g, M[0].color.b].join(",") + ")";
        for (let t = 0; t < M.length; t++)
            if (n <= M[t].pct)
                return i
                    ? "rgb(" + [M[t].color.r, M[t].color.g, M[t].color.b].join(",") + ")"
                    : ((s = M[t - 1]),
                      (g = (m = M[t]).pct - s.pct),
                      (d = 1 - (u = (n - s.pct) / g)),
                      (p = u),
        ...
        (n.prototype.refresh = function (t, n, e, i) {
            ...
            (n = u(n) ? n : null),
                ...
                null !== e &&
                    ...
                    o.config.reverse
                        ? (o.txtMax.attr({ text: o.txtMinimum }), l(o.txtMax, o.params.minFontSize, o.params.minY))
                        : (o.txtMin.attr({ text: o.txtMinimum }), l(o.txtMin, o.params.minFontSize, o.params.minY))),
                null !== n &&
                    ((o.config.max = n),
                    ...
                    o.config.reverse
                        ? (o.txtMin.attr({ text: o.txtMaximum }), l(o.txtMin, o.params.maxFontSize, o.params.maxY))
                        : (o.txtMax.attr({ text: o.txtMaximum }), l(o.txtMax, o.params.maxFontSize, o.params.maxY))),
                (r = t),
                    ...
                    : o.config.humanFriendly
                      ...
                      : o.config.formatNumber
                        ...
                        : o.config.displayRemaining
                          ? (1 * (o.config.max - r)).toFixed(o.config.decimals) + o.config.symbol
                          : (1 * r).toFixed(o.config.decimals) + o.config.symbol),
                (o.originalValue = r),
                (o.config.value = 1 * t),
                o.config.counter ||
                    (o.txtValue.attr({ text: r }), l(o.txtValue, o.params.valueFontSize, o.params.valueY));
            let m = o.config.value;
            o.config.reverse && (m = 1 * o.config.max + 1 * o.config.min - 1 * o.config.value),
                o.level.animate(
                    { pki: [m], fill: c },
                ...
                o.config.pointer &&
                    o.needle.animate({ ndl: [m] }, o.config.refreshAnimationTime, o.config.refreshAnimationType);
        }),
        ...
        (n.prototype.generateShadow = function (t, n) {
            ...
            s.setAttribute("operator", "over"),
                ...
                e.config.showInnerShadow &&
                    (e.canvas.canvas.childNodes[2].setAttribute("filter", "url(#" + i + ")"),
                    e.canvas.canvas.childNodes[3].setAttribute("filter", "url(#" + i + ")"));
        });
    const g = (function () {
        let t = 3;
