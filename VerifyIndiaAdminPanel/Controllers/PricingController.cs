...
namespace UpgrowAdminPanel.Controllers
{
    ...
    await _pricingService
        ...
        #region Manage Whitelabel Pricing
        [HttpGet]
        public async Task<IActionResult> ManageWhiteLabelPricing()
        {
            var platformOwnerTask =  _commonService.GetPlatformOwnerUUID();
            var categoryListTask =  LoadDropdownAsync(_apiCategoryService, x => x.CategoryName);
        ...
        [HttpPost]
        public async Task<IActionResult> GetWhiteLabelPriceTbl([FromBody] CWPricingFilterDto model)
        {
            if (!ModelState.IsValid || model == null)
            {
                return InvalidResponse(
        ...
        [HttpPost]
        public async Task<IActionResult> SaveWhiteLabelPricing([FromBody] SavePricingRequestDto model)
        {
            if (model == null)
            {
                return Json(new
            ...
            var result =
                await _pricingService
                    .SaveWhiteLabelPricingAsync(model);
