...
namespace Upgrow.Application.Services.Auth
{
    public class NotificationService : INotificationChannel
    {
        ...
        private readonly IMasterEmailTemplateRepository _templateRepository;
        private readonly IMasterEmailCredentialRepository _credentialRepository;

        public NotificationService(
            IMasterEmailTemplateRepository templateRepository,
            IMasterEmailCredentialRepository credentialRepository, IMapper mapper,
        ...
        private async Task<EmailConfig> GetEmailTemplateAndCredentialAsync(decimal templateId)
        {
            ...
            var credential = _mapper.Map<MasterEmailCredentialDto>(entityCredential);
            int port = 587;
