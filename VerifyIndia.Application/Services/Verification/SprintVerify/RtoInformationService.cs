...
{
    public class RtoInformationService : IRtoInformationService
    {
        private readonly SprintVerifyClient _client;
        private readonly SprintMapper _sprintMapper;

        public RtoInformationService(
        ...
        public async Task<ApiResponse<JsonElement>> GetRtoInformation(RtoInformationDto request)
        {

            var response = await _client.PostAsync(
                ApiEndpoints.RTO_INFORMATION_ENDPOINT,
                request);
