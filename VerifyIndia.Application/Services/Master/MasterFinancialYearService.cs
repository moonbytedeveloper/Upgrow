...
{
    public class MasterFinancialYearService : MasterServiceBase<Master_FinancialYear, MasterFinancialYearDto, MasterFinancialYearCommand>, IMasterFinancialYearService
    {
        public MasterFinancialYearService(IMasterRepository<Master_FinancialYear> repository, IMapper mapper)
           : base(repository, mapper) { }

        // Define which field to check for duplicates
        protected override async Task<bool> IsDuplicateAsync(MasterFinancialYearCommand command)
        {
        ...
        protected override Expression<Func<Master_FinancialYear, bool>>? BuildSearchFilter(string searchTerm)
        {
        ...
        protected override Func<IQueryable<Master_FinancialYear>, IOrderedQueryable<Master_FinancialYear>>? BuildSortExpression(
            string? sortColumn,
        ...
        protected override async Task ValidateAsync(MasterFinancialYearCommand command)
        {
