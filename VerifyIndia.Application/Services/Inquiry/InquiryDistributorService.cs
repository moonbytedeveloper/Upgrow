...
{
    public class InquiryDistributorService : IInquiryDistributorService
    {
        private readonly IInquiryDistributorRepository _repository;

        public InquiryDistributorService(IInquiryDistributorRepository repository)
        {
            _repository = repository;
        }

        private Expression<Func<Inquiry_Distributor, bool>>? BuildSearchFilter(string searchTerm)
        {
        ...
        private Func<IQueryable<Inquiry_Distributor>, IOrderedQueryable<Inquiry_Distributor>> BuildSortExpression(
            string? sortColumn,
        ...
        {
            Expression<Func<Inquiry_Distributor, bool>>? filter = null;
