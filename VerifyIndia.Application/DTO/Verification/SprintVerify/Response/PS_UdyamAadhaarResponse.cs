...
{
    public class PS_UdyamAadhaarResponse
    {
        public string? client_id { get; set; }
        public string? uan { get; set; }
        public string? certificate_url { get; set; }

        public MainDetails1? main_details { get; set; }

        public List<LocationOfPlantDetail1>? location_of_plant_details { get; set; }

        public List<NicCode1>? nic_code { get; set; }
    }
    public class MainDetails1
    {
        public List<EnterpriseType1>? enterprise_type_list { get; set; }
    ...
    public class LocationOfPlantDetail1
    {
