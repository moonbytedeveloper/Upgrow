document.addEventListener("DOMContentLoaded", function (e) {
    ...
    new JustGage({ id: "gg1", value: 125, title: "javascript call", defaults: n }),
        new JustGage({ id: "gg2", title: "data-attributes", defaults: n });
    function o(e, t) {
    ...
    new JustGage({ id: "jg1", defaults: n1 }),
        new JustGage({ id: "jg2", defaults: n2 }),
        new JustGage({ id: "jg3", defaults: n3 }),
        new JustGage({ id: "jg4", defaults: n4 }),
        new JustGage({ id: "jg5", defaults: r }),
        new JustGage({ id: "jg6", defaults: r });
});
