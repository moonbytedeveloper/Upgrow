...
{
    public class WL_MasterCityConfiguration : IEntityTypeConfiguration<WL_MasterCity>
    {
        public void Configure(EntityTypeBuilder<WL_MasterCity> builder)
        {
            // Table name
            builder.ToTable("WL_MasterCity");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_City_UUID");
