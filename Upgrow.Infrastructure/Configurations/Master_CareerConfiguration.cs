...
{
    public class Master_CareerConfiguration : IEntityTypeConfiguration<Master_Career>
    {
        public void Configure(EntityTypeBuilder<Master_Career> builder)
        {
            // Table name
            builder.ToTable("Master_Career");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Career_UUID");
