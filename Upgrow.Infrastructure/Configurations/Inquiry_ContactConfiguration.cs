...
{
    public class Inquiry_ContactConfiguration : IEntityTypeConfiguration<Inquiry_Contact>
    {
        public void Configure(EntityTypeBuilder<Inquiry_Contact> builder)
        {
            // Table name
            builder.ToTable("Inquiry_Contact");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Inquiry_Contact_UUID");
