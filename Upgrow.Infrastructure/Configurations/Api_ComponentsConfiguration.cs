...
{
    public class Api_ComponentsConfiguration : IEntityTypeConfiguration<Api_Components>
    {
        public void Configure(EntityTypeBuilder<Api_Components> builder)
        {
            // Table name
            builder.ToTable("Api_Components");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Api_Components_UUID");
