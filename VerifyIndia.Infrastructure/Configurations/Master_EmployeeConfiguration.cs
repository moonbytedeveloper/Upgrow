...
{
    public class Master_EmployeeConfiguration : IEntityTypeConfiguration<Master_Employee>
    {
        public void Configure(EntityTypeBuilder<Master_Employee> builder)
        {
            // Table name
            builder.ToTable("Master_Employee");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Employee_UUID");
