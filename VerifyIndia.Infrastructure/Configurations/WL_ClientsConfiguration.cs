...
{
    public class WL_ClientsConfiguration : IEntityTypeConfiguration<WL_Clients>
    {
        public void Configure(EntityTypeBuilder<WL_Clients> builder)
        {
            // Table name
            builder.ToTable("WL_Clients");
