...
{
    public class Master_StateConfiguration : IEntityTypeConfiguration<Master_State>
    {
        public void Configure(EntityTypeBuilder<Master_State> builder)
        {
            // Table name
            builder.ToTable("Master_State");
