...
{
    public class Knowledge_HubConfiguration : IEntityTypeConfiguration<Knowledge_Hub>
    {
        public void Configure(EntityTypeBuilder<Knowledge_Hub> builder)
        {
            // Table name
            builder.ToTable("Knowledge_Hub");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Knowledge_Hub_UUID");
