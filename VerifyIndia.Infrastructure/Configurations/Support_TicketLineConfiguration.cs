...
{
    public class Support_TicketLineConfiguration : IEntityTypeConfiguration<Support_TicketLine>
    {
        public void Configure(EntityTypeBuilder<Support_TicketLine> builder)
        {
            // Table name
            builder.ToTable("Support_TicketLine");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Support_TicketLine_UUID");
