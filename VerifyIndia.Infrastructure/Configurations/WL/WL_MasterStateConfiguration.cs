...
{
    public class WL_MasterStateConfiguration : IEntityTypeConfiguration<WL_MasterState>
    {
        public void Configure(EntityTypeBuilder<WL_MasterState> builder)
        {
            // Table name
            builder.ToTable("WL_MasterState");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_State_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_Master_State_Title");
