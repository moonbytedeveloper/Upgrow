...
{
    public class WL_MasterGenderConfiguration : IEntityTypeConfiguration<WL_MasterGender>
    {
        public void Configure(EntityTypeBuilder<WL_MasterGender> builder)
        {
            // Table name
            builder.ToTable("WL_MasterGender");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_WL_MasterGender_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_WL_MasterGender_Title");
