...
{
    internal class WL_MasterHonorificConfiguration : IEntityTypeConfiguration<WL_MasterHonorific>
    {
        public void Configure(EntityTypeBuilder<WL_MasterHonorific> builder)
        {
            // Table name
            builder.ToTable("WL_MasterHonorific");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_WL_MasterHonorific_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_WL_MasterHonorific_Title");
