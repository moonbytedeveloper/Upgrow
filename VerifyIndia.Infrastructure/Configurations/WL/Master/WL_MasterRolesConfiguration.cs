...
{
    public class WL_MasterRolesConfiguration : IEntityTypeConfiguration<WL_MasterRoles>
    {
        public void Configure(EntityTypeBuilder<WL_MasterRoles> builder)
        {
            // Table name
            builder.ToTable("WL_MasterRoles");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_WL_MasterRoles_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_WL_MasterRoles_Title");
