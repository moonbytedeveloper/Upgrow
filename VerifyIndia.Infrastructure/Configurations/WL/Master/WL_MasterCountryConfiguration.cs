...
{
    public class WL_MasterCountryConfiguration : IEntityTypeConfiguration<WL_MasterCountry>
    {
        public void Configure(EntityTypeBuilder<WL_MasterCountry> builder)
        {
            // Table name
            builder.ToTable("WL_MasterCountry");
