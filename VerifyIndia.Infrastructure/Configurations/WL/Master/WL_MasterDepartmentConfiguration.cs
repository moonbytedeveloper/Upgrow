...
{
    public class WL_MasterDepartmentConfiguration : IEntityTypeConfiguration<WL_MasterDepartment>
    {
        public void Configure(EntityTypeBuilder<WL_MasterDepartment> builder)
        {
            // Table name
            builder.ToTable("WL_MasterDepartment");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_WL_MasterDepartment_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_WL_MasterDepartment_Title");
