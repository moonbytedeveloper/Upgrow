...
{
    public class Master_RoleConfiguration : IEntityTypeConfiguration<Master_Roles>
    {
        public void Configure(EntityTypeBuilder<Master_Roles> builder)
        {
            // Table name
            builder.ToTable("Master_Roles");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Role_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_Master_Role_Title");
