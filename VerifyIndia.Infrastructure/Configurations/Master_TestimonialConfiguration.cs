...
{
    public class Master_TestimonialConfiguration : IEntityTypeConfiguration<Master_Testimonial>
    {
        public void Configure(EntityTypeBuilder<Master_Testimonial> builder)
        {
            // Table name
            builder.ToTable("Master_Testimonial");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Testimonial_UUID");
