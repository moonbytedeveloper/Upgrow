...
{
    public class Master_MenuConfiguration : IEntityTypeConfiguration<Master_Menu>
    {
        public void Configure(EntityTypeBuilder<Master_Menu> builder)
        {
            // Table name
            builder.ToTable("Master_Menu");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Menu_UUID");
