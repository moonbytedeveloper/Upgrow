...
{
    public class Master_SkillsConfiguration : IEntityTypeConfiguration<Master_Skills>
    {
        public void Configure(EntityTypeBuilder<Master_Skills> builder)
        {
            // Table name
            builder.ToTable("Master_Skills");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_Skills_UUID");
            ...
            builder.HasIndex(x => x.Title)
                .HasDatabaseName("IX_Master_Skills_Title");
