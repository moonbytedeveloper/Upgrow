...
{
    public class Master_CmsConfiguration : IEntityTypeConfiguration<Master_CMS>
    {
        public void Configure(EntityTypeBuilder<Master_CMS> builder)
        {
            // Table name
            builder.ToTable("Master_CMS");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_Master_CMS_UUID");
