...
{
    public class WL_MasterCMSConfiguration : IEntityTypeConfiguration<WL_MasterCMS>
    {
        public void Configure(EntityTypeBuilder<WL_MasterCMS> builder)
        {
            // Table name
            builder.ToTable("WL_MasterCMS");
            ...
            builder.HasIndex(x => x.UUID)
                ...
                .HasDatabaseName("IX_WL_MasterCMS_UUID");
